...
class DomExtractor extends AbstractRecordTransformer {
    ...
    async transform(data) {
        ...
        if (this.documentsProcessed % 100 === 0) {
            this.logger.debug(`DomExtractor: Processed ${this.documentsProcessed}, transformed: ${this.documentsTransformed}, Skipped: ${this.documentsSkipped}`)
        }
        ...
        this.documentSteps && this.logger.debug(`DomExtractor:\t\tbegin ${data.url}`);
        ...
        this.documentSteps && this.logger.debug(`DomExtractor:\t\tcomplete ${data.url}`);

        this.documentsTransformed = this.documentsTransformed + 1;
        return docInfo;
    }
     ...
     */
    async end() {
        this.logger.info(`DomExtractor: Processed ${this.documentsProcessed}, transformed: ${this.documentsTransformed}, Skipped: ${this.documentsSkipped}`)
